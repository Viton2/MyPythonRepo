...
from IHC.DAO.ExercicioBackEnd.dao import Exercicio as tdao

dados = tdao.ExercicioDAO()
...
class ExercicioRest(Resource):
    def __init__(self):
        self.campos = ['idt_exercicio', 'nme_exercicio', 'dsc_exercicio', 'num_repeticao_exercicio',
                       'num_gasto_calorico_exercicio']
