...
while continuar:
    ...
    clientes = ses.query(tb_disciplina).all()
    ...
    cli = ses.query(tb_disciplina).filter_by(idt_cliente=idt).first()
    ...
    servicos = ses.query(tb_aluno).all()
    ...
    serv = ses.query(tb_aluno).filter_by(idt_servico=idt).first()
